...
function t(key, vars) {
  var _a, _b, _c;
  const langMap = (_a = translations[currentLang]) != null ? _a : translations["en"];
  let str = (_c = (_b = langMap[key]) != null ? _b : translations["en"][key]) != null ? _c : key;
  if (vars) {
  ...
  onOpen() {
    ...
    switch (plugin.settings.deleteFilesAction) {
      ...
      case "obsidianTrash":
        ...
        break;
      case "delete":
        modalContent.createEl("p", { text: t("willBeDeleted") }).setCssStyles({ color: "red" });
        break;
    }
...
function getFolderNoteFolder(plugin, folderNote, fileName) {
  ...
  if (!plugin.settings.folderNoteName.includes("{{folder_name}}") && plugin.settings.storageLocation === "insideFolder") {
    ...
    const file = plugin.app.vault.getAbstractFileByPath(filePath);
    return file instanceof import_obsidian17.TFile ? file.parent : null;
  }
  if (!folderName)
    return null;
...
async function renderGeneral(settingsTab) {
  ...
  new import_obsidian24.Setting(containerEl).setName(t("language")).setDesc(t("languageDesc")).addDropdown((dropdown) => {
    var _a;
    dropdown.addOption("en", t("langEnglish"));
    dropdown.addOption("zh", t("langChinese"));
    dropdown.setValue((_a = settingsTab.plugin.settings.language) != null ? _a : "en");
  ...
  const nameSetting = new import_obsidian24.Setting(containerEl).setName(t("folderNoteNameTemplate")).setDesc(t("folderNoteNameTemplateDesc")).addText((text) => text.setValue(settingsTab.plugin.settings.folderNoteName).onChange(async (value) => {
    if (value.trim() === "") {
      return;
    }
  ...
  })).addButton((button) => button.setButtonText(t("renameExistingFolderNotes")).setCta().onClick(async () => {
    new RenameFolderNotesModal(settingsTab.plugin, t("renameAllExistingFolderNotes"), t("renameConfirmMsg"), settingsTab.renameFolderNotes, []).open();
  }));
  ...
  if (!settingsTab.plugin.settings.folderNoteName.includes("{{folder_name}}")) {
    new import_obsidian24.Setting(containerEl).setName(t("displayFolderNameInTabTitle")).setDesc(t("displayFolderNameInTabTitleDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.tabManagerEnabled).onChange(async (value) => {
      if (!value) {
  ...
  new import_obsidian24.Setting(containerEl).setName(t("defaultFileType")).setDesc(t("defaultFileTypeDesc")).addDropdown((dropdown) => {
  ...
  if (!settingsTab.plugin.settings.supportedFileTypes.includes("md") || !settingsTab.plugin.settings.supportedFileTypes.includes("canvas") || !settingsTab.plugin.settings.supportedFileTypes.includes("excalidraw")) {
    ...
    setting0.addButton((button) => button.setButtonText(t("addCustomFileType")).setCta().onClick(async () => {
      new AddSupportedFileModal(settingsTab.app, settingsTab.plugin, settingsTab, list).open();
    }));
  }
  const templateSetting = new import_obsidian24.Setting(containerEl).setDesc(t("templatePathDesc")).setName(t("templatePath")).addSearch((cb) => {
  ...
  const storageLocation = new import_obsidian24.Setting(containerEl).setName(t("storageLocation")).setDesc(t("storageLocationDesc")).addDropdown((dropdown) => dropdown.addOption("insideFolder", t("insideFolder")).addOption("parentFolder", t("inParentFolder")).setValue(settingsTab.plugin.settings.storageLocation).onChange(async (value) => {
    settingsTab.plugin.settings.storageLocation = value;
    await settingsTab.plugin.saveSettings();
    settingsTab.display();
    refreshAllFolderStyles(void 0, settingsTab.plugin);
  })).addButton((button) => button.setButtonText(t("switchButton")).setCta().onClick(async () => {
    ...
    new BackupWarningModal(settingsTab.plugin, t("switchStorageLocationTitle"), t("switchStorageLocationMsg"), settingsTab.switchStorageLocation, [oldStorageLocation]).open();
  }));
  ...
  if (settingsTab.plugin.settings.storageLocation === "parentFolder") {
    new import_obsidian24.Setting(containerEl).setName(t("deleteFolderNotesOnFolderDelete")).setDesc(t("deleteFolderNotesOnFolderDeleteDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.syncDelete).onChange(async (value) => {
      settingsTab.plugin.settings.syncDelete = value;
      await settingsTab.plugin.saveSettings();
    }));
    new import_obsidian24.Setting(containerEl).setName(t("moveFolderNotesOnFolderMove")).setDesc(t("moveFolderNotesOnFolderMoveDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.syncMove).onChange(async (value) => {
  ...
  if (import_obsidian24.Platform.isDesktopApp) {
    ...
    new import_obsidian24.Setting(containerEl).setName(t("keyForCreatingFolderNote")).setDesc(t("keyForCreatingFolderNoteDesc")).addDropdown((dropdown) => {
    ...
    new import_obsidian24.Setting(containerEl).setName(t("keyForOpeningFolderNote")).setDesc(t("keyForOpeningFolderNoteDesc")).addDropdown((dropdown) => {
  ...
  new import_obsidian24.Setting(containerEl).setName(t("confirmFolderNoteDeletion")).setDesc(t("confirmFolderNoteDeletionDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.showDeleteConfirmation).onChange(async (value) => {
    settingsTab.plugin.settings.showDeleteConfirmation = value;
    await settingsTab.plugin.saveSettings();
    settingsTab.display();
  }));
  new import_obsidian24.Setting(containerEl).setName(t("deletedFolderNotes")).setDesc(t("deletedFolderNotesDesc")).addDropdown((dropdown) => {
  ...
  if (settingsTab.plugin.settings.openInNewTab) {
    new import_obsidian24.Setting(containerEl).setName(t("focusExistingTab")).setDesc(t("focusExistingTabDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.focusExistingTab).onChange(async (value) => {
      settingsTab.plugin.settings.focusExistingTab = value;
      await settingsTab.plugin.saveSettings();
      settingsTab.display();
    }));
  }
  new import_obsidian24.Setting(containerEl).setName(t("syncFolderName")).setDesc(t("syncFolderNameDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.syncFolderName).onChange(async (value) => {
    settingsTab.plugin.settings.syncFolderName = value;
    await settingsTab.plugin.saveSettings();
    settingsTab.display();
  }));
  settingsTab.settingsPage.createEl("h4", { text: t("automationSettings") });
  new import_obsidian24.Setting(containerEl).setName(t("createFolderNotesForAllFolders")).setDesc(t("createFolderNotesForAllFoldersDesc")).addButton((cb) => {
    cb.setIcon("plus");
  ...
  new import_obsidian24.Setting(containerEl).setName(t("autoCreateOnFolderCreation")).setDesc(t("autoCreateOnFolderCreationDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.autoCreate).onChange(async (value) => {
    settingsTab.plugin.settings.autoCreate = value;
    await settingsTab.plugin.saveSettings();
    settingsTab.display();
  }));
  if (settingsTab.plugin.settings.autoCreate) {
    new import_obsidian24.Setting(containerEl).setName(t("autoOpenAfterCreation")).setDesc(t("autoOpenAfterCreationDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.autoCreateFocusFiles).onChange(async (value) => {
      settingsTab.plugin.settings.autoCreateFocusFiles = value;
      await settingsTab.plugin.saveSettings();
      settingsTab.display();
    }));
    new import_obsidian24.Setting(containerEl).setName(t("autoCreateForAttachmentFolders")).setDesc(t("autoCreateForAttachmentFoldersDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.autoCreateForAttachmentFolder).onChange(async (value) => {
      settingsTab.plugin.settings.autoCreateForAttachmentFolder = value;
      await settingsTab.plugin.saveSettings();
      settingsTab.display();
    }));
  }
  new import_obsidian24.Setting(containerEl).setName(t("autoCreateWhenCreatingNotes")).setDesc(t("autoCreateWhenCreatingNotesDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.autoCreateForFiles).onChange(async (value) => {
  ...
  desc1.append(before != null ? before : "");
  desc1.appendChild(link);
  desc1.append(after != null ? after : "");
  const fmtpSetting = new import_obsidian24.Setting(containerEl).setName(t("enableFmtpIntegration")).setDesc(desc1).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.frontMatterTitle.enabled).onChange(async (value) => {
    var _a;
  ...
  new import_obsidian24.Setting(containerEl).setName(t("persistTabAfterRestart")).setDesc(t("persistTabAfterRestartDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.persistentSettingsTab.afterRestart).onChange(async (value) => {
    settingsTab.plugin.settings.persistentSettingsTab.afterRestart = value;
    await settingsTab.plugin.saveSettings();
    settingsTab.display();
  }));
  new import_obsidian24.Setting(containerEl).setName(t("persistTabDuringSession")).setDesc(t("persistTabDuringSessionDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.persistentSettingsTab.afterChangingTab).onChange(async (value) => {
...
async function renderFileExplorer(settingsTab) {
  const containerEl = settingsTab.settingsPage;
  new import_obsidian25.Setting(containerEl).setName(t("hideFolderNote")).setDesc(t("hideFolderNoteDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.hideFolderNote).onChange(async (value) => {
  ...
  const setting2 = new import_obsidian25.Setting(containerEl).setName(t("disableClickToOpenOnMobile")).setDesc(t("disableClickToOpenOnMobileDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.disableOpenFolderNoteOnClick).onChange(async (value) => {
  ...
  new import_obsidian25.Setting(containerEl).setName(t("openByClickingFolderNameOnly")).setDesc(t("openByClickingFolderNameOnlyDesc")).addToggle((toggle) => toggle.setValue(!settingsTab.plugin.settings.stopWhitespaceCollapsing).onChange(async (value) => {
    if (!value) {
  ...
  new import_obsidian25.Setting(containerEl).setName(t("useSubmenus")).setDesc(t("useSubmenusDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.useSubmenus).onChange(async (value) => {
    settingsTab.plugin.settings.useSubmenus = value;
    await settingsTab.plugin.saveSettings();
    settingsTab.display();
  }));
  if (settingsTab.plugin.settings.frontMatterTitle.enabled) {
    new import_obsidian25.Setting(containerEl).setName(t("autoUpdateFolderNameInExplorer")).setDesc(t("autoUpdateFolderNameInExplorerDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.frontMatterTitle.explorer).onChange(async (value) => {
  ...
  new import_obsidian25.Setting(containerEl).setName(t("highlightFolder")).setDesc(t("highlightFolderDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.highlightFolder).onChange(async (value) => {
  ...
  new import_obsidian25.Setting(containerEl).setName(t("hideCollapseIcon")).setDesc(t("hideCollapseIconDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.hideCollapsingIcon).onChange(async (value) => {
  ...
  new import_obsidian25.Setting(containerEl).setName(t("hideCollapseIconForEmptyFolders")).setDesc(t("hideCollapseIconForEmptyFoldersDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.hideCollapsingIconForEmptyFolders).onChange(async (value) => {
  ...
  if (settingsTab.plugin.settings.hideCollapsingIcon) {
    new import_obsidian25.Setting(containerEl).setName(t("hideCollapseIconForAttachmentFolder")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.ignoreAttachmentFolder).onChange(async (value) => {
      if (value) {
  ...
  new import_obsidian25.Setting(containerEl).setName(t("underlineFolderNote")).setDesc(t("underlineFolderNoteDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.underlineFolder).onChange(async (value) => {
  ...
  new import_obsidian25.Setting(containerEl).setName(t("boldFolderNote")).setDesc(t("boldFolderNoteDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.boldName).onChange(async (value) => {
  ...
  new import_obsidian25.Setting(containerEl).setName(t("cursiveFolderNote")).setDesc(t("cursiveFolderNoteDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.cursiveName).onChange(async (value) => {
...
async function renderPath(settingsTab) {
  const containerEl = settingsTab.settingsPage;
  new import_obsidian26.Setting(containerEl).setName(t("openFolderNoteThroughPath")).setDesc(t("openFolderNoteThroughPathDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.openFolderNoteOnClickInPath).onChange(async (value) => {
    settingsTab.plugin.settings.openFolderNoteOnClickInPath = value;
    await settingsTab.plugin.saveSettings();
    settingsTab.display();
  }));
  if (settingsTab.plugin.settings.openFolderNoteOnClickInPath) {
    new import_obsidian26.Setting(containerEl).setName(t("openSidebarMobile")).setDesc(t("openSidebarMobileDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.openSidebar.mobile).onChange(async (value) => {
      settingsTab.plugin.settings.openSidebar.mobile = value;
      await settingsTab.plugin.saveSettings();
    }));
    new import_obsidian26.Setting(containerEl).setName(t("openSidebarDesktop")).setDesc(t("openSidebarDesktopDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.openSidebar.desktop).onChange(async (value) => {
      settingsTab.plugin.settings.openSidebar.desktop = value;
      await settingsTab.plugin.saveSettings();
    }));
  }
  if (settingsTab.plugin.settings.frontMatterTitle.enabled) {
    new import_obsidian26.Setting(containerEl).setName(t("autoUpdateFolderNameInPath")).setDesc(t("autoUpdateFolderNameInPathDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.frontMatterTitle.path).onChange(async (value) => {
  ...
  settingsTab.settingsPage.createEl("h3", { text: t("styleSettings") });
  new import_obsidian26.Setting(containerEl).setName(t("underlineFoldersInPath")).setDesc(t("underlineFoldersInPathDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.underlineFolderInPath).onChange(async (value) => {
  ...
  new import_obsidian26.Setting(containerEl).setName(t("boldFoldersInPath")).setDesc(t("boldFoldersInPathDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.boldNameInPath).onChange(async (value) => {
  ...
  new import_obsidian26.Setting(containerEl).setName(t("cursiveFoldersInPath")).setDesc(t("cursiveFoldersInPathDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.cursiveNameInPath).onChange(async (value) => {
  ...
  new import_obsidian26.Setting(containerEl).setName(t("hideFolderNoteNameInPath")).setDesc(t("hideFolderNoteNameInPathDesc")).addToggle((toggle) => toggle.setValue(settingsTab.plugin.settings.hideFolderNoteNameInPath).onChange(async (value) => {
...
async function renderFolderOverview(settingsTab) {
  ...
  new import_obsidian37.Setting(containerEl).setName(t("autoUpdateLinks")).setDesc(t("autoUpdateLinksDesc")).addToggle((toggle) => toggle.setValue(plugin.settings.fvGlobalSettings.autoUpdateLinks).onChange(async (value) => {
...
async function renderExcludeFolders(settingsTab) {
  const containerEl = settingsTab.settingsPage;
  const manageExcluded = new import_obsidian39.Setting(containerEl).setHeading().setClass("fn-excluded-folder-heading").setName(t("manageExcludedFolders"));
  const desc3 = document.createDocumentFragment();
  desc3.append(t("manageExcludedFoldersDesc1"), desc3.createEl("br"), t("manageExcludedFoldersDesc2"), desc3.createEl("br"), t("manageExcludedFoldersDesc3"), desc3.createEl("br"), t("manageExcludedFoldersDesc4"));
  ...
  new import_obsidian39.Setting(containerEl).setName(t("whitelistedFolders")).setDesc(t("whitelistedFoldersDesc")).addButton((cb) => {
  ...
  new import_obsidian39.Setting(containerEl).setName(t("excludeFolderDefaultSettings")).addButton((cb) => {
    cb.setButtonText(t("manage"));
    cb.setCta();
    cb.onClick(async () => {
  ...
  new import_obsidian39.Setting(containerEl).setName(t("excludePatternDefaultSettings")).addButton((cb) => {
    cb.setButtonText(t("manage"));
    cb.setCta();
    cb.onClick(async () => {
  ...
  new import_obsidian39.Setting(containerEl).setName(t("addExcludedFolder")).setClass("add-exclude-folder-item").addButton((cb) => {
    cb.setIcon("plus");
    cb.setClass("add-exclude-folder");
...
var SettingsTab2 = class extends import_obsidian40.PluginSettingTab {
  ...
  renameFolderNotes() {
    var _a, _b, _c;
    new import_obsidian40.Notice(t("startingUpdateFolderNotes"));
    ...
    this.plugin.saveSettings();
    new import_obsidian40.Notice(t("finishedUpdatingFolderNotes"));
  }
  switchStorageLocation(oldMethod) {
    new import_obsidian40.Notice(t("startingSwitchStorageLocation"));
    ...
    new import_obsidian40.Notice(t("finishedSwitchingStorageLocation"));
  }
  onClose() {
    ...
    this.plugin.addCommand({
      ...
      callback: async () => {
        ...
        if (this.plugin.app.vault.getAbstractFileByPath(newPath)) {
          return new import_obsidian41.Notice(t("noticeFolderAlreadyExists"));
        }
        ...
        if (text && text.trim() !== "") {
          ...
          for (const char of blacklist) {
            if (text.includes(char)) {
              new import_obsidian41.Notice(t("noticeInvalidFileName"));
              return false;
            }
          }
          if (text.endsWith(".")) {
            new import_obsidian41.Notice(t("noticeFileNameEndDot"));
            return;
          }
          let folder;
          const folderPath = getFolderPathFromString(file.path);
          if (folderPath === "") {
            ...
            if (folder instanceof import_obsidian41.TFolder) {
              new import_obsidian41.Notice(t("noticeFolderNoteAlreadyExists"));
              return false;
            }
            ...
            if (this.plugin.settings.storageLocation === "parentFolder") {
              if (this.app.vault.getAbstractFileByPath(folderPath + "/" + text + this.plugin.settings.folderNoteType)) {
                new import_obsidian41.Notice(t("noticeFileAlreadyExists"));
                return false;
              }
            }
    ...
    this.plugin.registerEvent(this.app.workspace.on("file-menu", (menu, file) => {
      ...
      const addFolderNoteActions = (folderMenu) => {
        if (file instanceof import_obsidian41.TFile) {
          ...
          folderMenu.addItem((item) => {
            var _a2;
            item.setTitle(t("menuTurnIntoFolderNote", { folderName: (_a2 = folder == null ? void 0 : folder.name) != null ? _a2 : "" }));
            item.setIcon("edit");
            item.onClick(() => {
              if (!folder || !(folder instanceof import_obsidian41.TFolder))
                return;
        ...
        if (excludedFolder && !excludedFolder.hideInSettings) {
          folderMenu.addItem((item) => {
            ...
            item.onClick(() => {
              ...
              new import_obsidian41.Notice(t("noticeRemovedFromExcluded"));
            });
          });
          return;
        }
        ...
        folderMenu.addItem((item) => {
          ...
          item.onClick(() => {
            ...
            this.plugin.saveSettings(true);
            new import_obsidian41.Notice(t("noticeExcluded"));
          });
        });
        if (!(file instanceof import_obsidian41.TFolder))
          return;
  ...
  editorCommands() {
    this.plugin.registerEvent(this.plugin.app.workspace.on("editor-menu", (menu, editor, view) => {
      ...
      if (!text || text.trim() === "")
        return;
      menu.addItem((item) => {
        item.setTitle(t("menuCreateFolderNote")).setIcon("edit").onClick(() => {
          const { file } = view;
          if (!(file instanceof import_obsidian41.TFile))
            return;
          const blacklist = ["*", "\\", '"', "/", "<", ">", "?", "|", ":"];
          ...
          if (folderPath === "") {
            folder = this.plugin.app.vault.getAbstractFileByPath(text);
            if (folder instanceof import_obsidian41.TFolder) {
              return new import_obsidian41.Notice(t("noticeFolderNoteAlreadyExists"));
            }
            this.plugin.app.vault.createFolder(text);
            createFolderNote(this.plugin, text, false);
          } else {
            ...
            if (this.plugin.settings.storageLocation === "parentFolder") {
              if (this.app.vault.getAbstractFileByPath(folderPath + "/" + fileName + this.plugin.settings.folderNoteType)) {
                return new import_obsidian41.Notice(t("noticeFileAlreadyExists"));
              }
            }
            this.plugin.app.vault.createFolder(folderPath + "/" + text);
            createFolderNote(this.plugin, folderPath + "/" + text, false);
...
async function updateFolderNamesInPath(plugin, titleContainer) {
  ...
  titleParent == null ? void 0 : titleParent.childNodes.forEach(async (breadcrumb) => {
    ...
    if (viewHeaderTitle && folderNote) {
      ...
      const file = plugin.app.vault.getAbstractFileByPath(filePath);
      const folder = getFolderNoteFolder(plugin, folderNote, (_b = file == null ? void 0 : file.name) != null ? _b : "");
      if (folder && file && file.path === (folderNote == null ? void 0 : folderNote.path) && ((_c = file.parent) == null ? void 0 : _c.path) !== "/") {
        (_d = viewHeaderTitle.parentElement) == null ? void 0 : _d.classList.add("hide-folder-note-title-in-path");
        viewHeaderTitle.classList.add("path-is-folder-note");
      } else {
        (_e = viewHeaderTitle.parentElement) == null ? void 0 : _e.classList.remove("hide-folder-note-title-in-path");
    ...
    if (plugin.settings.frontMatterTitle.enabled) {
      (_f = plugin.fmtpHandler) == null ? void 0 : _f.fmptUpdateFolderName({ id: "", result: false, path: folderPath, pathOnly: true, breadcrumb }, true);
    }
  });
}
...
var FolderNotesPlugin = class extends import_obsidian52.Plugin {
  ...
  async onload() {
    ...
    await this.loadSettings();
    setLanguage((_a = this.settings.language) != null ? _a : "en");
    ...
    this.registerDomEvent(window, "keydown", (event) => {
      ...
      if (!import_obsidian52.Keymap.isModEvent(event))
        return;
      const folderPath = ((_a2 = hoveredElement == null ? void 0 : hoveredElement.parentElement) == null ? void 0 : _a2.getAttribute("data-path")) || "";
